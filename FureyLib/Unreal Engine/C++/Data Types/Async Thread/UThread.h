...
DECLARE_DYNAMIC_DELEGATE(FUThreadDelegate);

/**
 * Runs a delegate on a separate thread.
 * Construct with NewTGhy
...
protected:
	...
	FUThreadDelegate Delegate = FUThreadDelegate();
...
public:
	...
	*/
	...
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Multithreading")
	virtual FUThreadDelegate& GetDelegate();
	...
	static UThread* NewThread(const FUThreadDelegate& Event, FName Name = "New Thread", bool bStart = true);
