...
// Flow Data Game Mode Base Class Script
// by Kyle Furey for NASA VR Project

// REQUIREMENTS: Flow Files, ParticleVisibility.cs

using UnityEngine;
using UnityEngine.Events;

/// <summary>
/// Flow data game mode enum.
/// </summary>
public enum FlowGameModeType
{
    /// <summary>
    ...
    /// <summary>
    /// •  Air Hockey - The player deflects an accelerating particle puck moving across a 2D plane from their goal.<br/>
    /// •  Each time the particle puck enters the opponent's goal, the player earns a point.<br/>
    /// •  If the particle puck enters their goal, they lose a life.
    /// </summary>
    AirHockey = 1,

    /// <summary>
    /// •  Pong - The player deflects particles gravitating towards themselves and earns points each time a particle hits the bounds.<br/>
    /// •  The player loses a life each time they miss a particle. More particles appear over time.
    /// </summary>
    Pong = 2,

    /// <summary>
    /// •  Breakout - The player bounces a particle away to break bricks above them. Each brick they break is a point.<br/>
    /// •  If the particle touches the ground, the player loses a life. If the player clears a stage, the particle moves faster.
    /// </summary>
    Breakout = 3,

    /// <summary>
    /// •  Baseball - The player hits a particle across a stage to go through rings and hit targets.<br/>
    /// •  The more rings and targets the particle goes through, the more points the player gets.<br/>
    /// •  The player has a limited number of particles they can hit.
    /// </summary>
    Baseball = 4,

    /// <summary>
    /// •  Galaga - The player shoots particles at aliens above themselves. Each alien they hit is a point.<br/>
    /// •  There are different types of aliens that move differently. If an alien hits or abducts the player, they lose a life.<br/>
    /// •  If the player clears all of the aliens, more aliens and harder aliens appear.
    /// </summary>
    Galaga = 5,
};

/// <summary>
/// Base class for a customizable game mode that uses flow data through generalized settings and virtual functions.
/// </summary>
public abstract class FlowGameMode : MonoBehaviour
{
    [Header("Base class for a customizable game mode through generalized settings and virtual functions.")]

    [Header("\nFLOW DATA SETTINGS")]

    [Header("Reference to the particle visibility script used to control the flow data:")]
    public ParticleVisibility flowDataCube = null;
    ...
    /// </summary>
    public FlowGameModeType type { get; protected set; }
