...
#define FIND_LEAKS _CrtSetDbgFlag(_CRTDBG_ALLOC_MEM_DF | _CRTDBG_LEAK_CHECK_DF); _CrtSetReportMode(_CRT_ERROR, _CRTDBG_MODE_DEBUG)

// •  Tracks allocated memory for memory leaks.
// •  Aborts the program when one is found after DUMP_LEAKS is called.
// •  Call this at the beginning of the program.
#define THROW_LEAKS _CrtSetDbgFlag(_CRTDBG_ALLOC_MEM_DF | _CRTDBG_LEAK_CHECK_DF); _CrtSetReportMode(_CRT_ERROR, _CRTDBG_MODE_WNDW)
