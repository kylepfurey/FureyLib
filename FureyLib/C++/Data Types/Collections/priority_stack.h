...
public:
	...
	// Node constructor
	priority_stack(priority_stack_node<data_type, priority_type> node)
	{
		my_stack = std::list<priority_stack_node<data_type, priority_type>>();
	...
	priority_stack(int array_size, priority_stack_node<data_type, priority_type>* nodes)
	{
		my_stack = std::list<priority_stack_node<data_type, priority_type>>();
	...
	// Node array constructor
	priority_stack(int argc, priority_stack_node<data_type, priority_type> array ...)
	{
		va_list _va_list;

		va_start(_va_list, argc);

		priority_stack_node<data_type, priority_type>* argv = new priority_stack_node<data_type, priority_type>[argc];

		for (int i = 0; i < argc; i++)
		{
			argv[i] = array;

			array = ((sizeof(priority_stack_node<data_type, priority_type>) > sizeof(__int64) || (sizeof(priority_stack_node<data_type, priority_type>) & (sizeof(priority_stack_node<data_type, priority_type>) - 1)) != 0) ? **(priority_stack_node<data_type, priority_type>**)((_va_list += sizeof(__int64)) - sizeof(__int64)) : *(priority_stack_node<data_type, priority_type>*)((_va_list += sizeof(__int64)) - sizeof(__int64)));
		}
	...
	priority_stack(std::vector<priority_stack_node<data_type, priority_type>> nodes)
	{
		my_stack = std::list<priority_stack_node<data_type, priority_type>>();
	...
	priority_stack(std::list<priority_stack_node<data_type, priority_type>> nodes)
	{
		my_stack = std::list<priority_stack_node<data_type, priority_type>>();

		for (priority_stack_node<data_type, priority_type> node : nodes)
		{
			push(node);
		}
	}
	...
	priority_stack(std::initializer_list<priority_stack_node<data_type, priority_type>> nodes)
	{
		my_stack = std::list<priority_stack_node<data_type, priority_type>>();
