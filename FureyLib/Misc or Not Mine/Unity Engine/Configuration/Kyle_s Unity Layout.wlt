...
MonoBehaviour:
  ...
  m_MinSize: {x: 0, y: 0}
  m_MaxSize: {x: 0, y: 0}
  m_LastLoadedLayoutName: Kyle's Layout
--- !u!114 &4
MonoBehaviour:
  m_ObjectHideFlags: 52
  m_CorrespondingSourceObject: {fileID: 0}
...
MonoBehaviour:
  ...
  m_SceneHierarchy:
    m_TreeViewState:
      ...
      m_SelectedIDs: 
      m_LastClickedID: 0
      m_ExpandedIDs: cce4ffffcee4ffffa8e8ffffc4f3ffff08fbffff42fbfffff4c80000
      m_RenameOverlay:
...
MonoBehaviour:
  ...
  m_OverlayCanvas:
    ...
    - dockPosition: 0
      ...
      id: Tool Settings
      index: 0
      contents: '{"m_Layout":1,"m_Collapsed":false,"m_Folded":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":-161.0,"y":-26.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":3,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
    ...
    - dockPosition: 1
      ...
      index: 1
      contents: '{"m_Layout":1,"m_Collapsed":false,"m_Folded":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":-301.0,"y":0.0010000000474974514},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":1,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: -301, y: 0.001}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 1
      layout: 1
      size: {x: 0, y: 0}
    ...
    - dockPosition: 0
      ...
      index: 0
      contents: '{"m_Layout":1,"m_Collapsed":false,"m_Folded":false,"m_Floating":true,"m_FloatingSnapOffset":{"x":302.0,"y":0.001007080078125},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":0,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 1
      collapsed: 0
      snapOffset: {x: 302, y: 0.0010070801}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 0
      layout: 1
      size: {x: 0, y: 0}
    ...
    - dockPosition: 0
      ...
      index: 0
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Folded":true,"m_Floating":true,"m_FloatingSnapOffset":{"x":-215.0,"y":-224.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":3,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 1
      collapsed: 0
      snapOffset: {x: -215, y: -224}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 3
      layout: 4
      size: {x: 0, y: 0}
  ...
  m_Position:
    ...
    speed: 2
    m_Value: {x: 0.027884673, y: -0.0063417163, z: 0}
  m_RenderMode: 0
  m_CameraMode:
    drawMode: 0
    name: Shaded
...
MonoBehaviour:
  ...
  m_LastProjectPath: D:\Feltopia\Feltopia
  m_LockTracker:
    m_IsLocked: 0
  m_FolderTreeState:
    scrollPos: {x: 0, y: 0}
    m_SelectedIDs: 86750100
    m_LastClickedID: 95622
    m_ExpandedIDs: 0000000086750100
    m_RenameOverlay:
      m_UserAcceptedRename: 0
      m_Name: 
      m_OriginalName: 
...
MonoBehaviour:
  ...
  m_ZoomArea:
    ...
    m_DrawArea:
      ...
      width: 320
      height: 181
    m_Scale: {x: 0.083333336, y: 0.083333336}
    m_Translation: {x: 160, y: 90.5}
    m_MarginLeft: 0
    m_MarginRight: 0
    m_MarginTop: 0
    m_MarginBottom: 0
    m_LastShownAreaInsideMargins:
      ...
      height: 2172
    m_MinimalGUI: 1
  m_defaultScale: 0.083333336
  m_LastWindowPixelSize: {x: 320, y: 202}
  m_ClearInEditMode: 1
  m_NoCameraWarning: 1
